<template>
  <view class="uni-date">
    <view :class="{'uni-date-editor--x__disabled': disabled,
      ...
      <view v-if="!isRange" class="uni-date-x uni-date-single" @click="show">
        <view class="uni-date__icon-logo">
          <image :src="iconBase64" class="uni-date-editor--logo" mode=""></image>
        </view>
        <input v-model="singleVal" :disabled="true" :placeholder="placeholder" class="uni-date__input"
               type="text"/>
      </view>
      ...
      <view v-else :style="popover" class="uni-date-range--x">
        <view v-show="hasTime" class="popup-x-header uni-date-changed">
          <view class="popup-x-header--datetime">
            <input v-model="tempRange.startDate" class="uni-date__input uni-date-range__input" placeholder="开始日期"
                   type="text"/>
            <time-picker v-model="tempRange.startTime" :border="false" :disabled="!tempRange.startDate"
              ...
              <input v-model="tempRange.startTime" :disabled="!tempRange.startDate"
                     class="uni-date__input uni-date-range__input" placeholder="开始时间" type="text"/>
            </time-picker>
          </view>
          <uni-icons color="#999" style="line-height: 40px;" type="arrowthinright"></uni-icons>
          <view class="popup-x-header--datetime">
            <input v-model="tempRange.endDate" class="uni-date__input uni-date-range__input" placeholder="结束日期"
                   type="text"/>
            <time-picker v-model="tempRange.endTime" :border="false" :disabled="!tempRange.endDate" :end="reactEndTime"
                         type="time">
              <input v-model="tempRange.endTime" :disabled="!tempRange.endDate"
        ...
        <view class="popup-x-body">
          <calendar ref="left" :end-date="caleRange.endDate" :pleStatus="endMultipleStatus"
                    :range="true" :showMonth="false" :start-date="caleRange.startDate" style="padding-right: 16px;"
          ...
          <calendar ref="right" :end-date="caleRange.endDate" :pleStatus="startMultipleStatus"
                    ...
                    style="padding-left: 16px;border-left: 1px solid #F1F1F1;" @change="rightChange"
    ...
    <calendar ref="mobile" :clearDate="false" :date="defSingleDate" :defTime="reactMobDefTime"
              :end-date="caleRange.endDate" :insert="false" :pleStatus="endMultipleStatus"
              :range="isRange" :selectableTimes="mobSelectableTime" :showMonth="false" :start-date="caleRange.startDate"
              :typeHasTime="hasTime"
