<template>
  <view v-if="show" :style="{ backgroundColor: backgroundColor }" class="uni-noticebar" @click="onClick">
    ...
    <view v-if="showClose === true || showClose === 'true'" class="uni-noticebar-close uni-cursor-point" @click="close">
      <uni-icons :color="color" size="12" type="closeempty"/>
    </view>
    ...
    <!-- #endif -->
    <!-- #ifndef MP-ALIPAY -->
    <uni-icons v-if="showClose === true || showClose === 'true'" :color="color"
               class="uni-noticebar-close uni-cursor-point" size="12"
               type="closeempty" @click="close"/>
    ...
    <view ref="textBox"
      ...
      <view :id="elIdBox"
        ...
        <text :id="elId" ref="animationEle"
              ...
              class="uni-noticebar__content-text">{{ text }}
        </text>
      </view>
    </view>
