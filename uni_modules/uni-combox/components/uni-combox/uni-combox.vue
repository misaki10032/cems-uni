<template>
  <view class="uni-combox">
    ...
    <view class="uni-combox__input-box">
      <input v-model="inputVal" :placeholder="placeholder" class="uni-combox__input" type="text" @blur="onBlur"
             @focus="onFocus" @input="onInput"/>
      <uni-icons class="uni-combox__input-arrow" size="14" type="arrowdown" @click="toggleSelector"></uni-icons>
