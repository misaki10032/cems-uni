<template>
  <view class="uni-cursor-point">
    ...
    <view :class="{
      ...
      <view :class="{'uni-fab__plus--active': isShow && content.length > 0}" class="fab-circle-v"></view>
      <view :class="{'uni-fab__plus--active': isShow  && content.length > 0}" class="fab-circle-h"></view>
    </view>
  </view>
</template>
