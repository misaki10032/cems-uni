...
<script>
	...
	export default {
		...
		methods: {
			getTasks(callback) {
				this.$myRequest({
					url: "/getPrincipalEntrusts?pageIndex=" + this.pageIndex + "&pageSize=" + this.pageSize + "&id=" + uni
			...
			bindPickerChange(res) {
				...
				this.$myRequest({
					url: "/getPrincipalEntbyPlan?entPlan=" + entPlan + "&pageIndex=" + this.pageIndex + "&pageSize=" +
			...
			searchTasks() {
				...
				const entPlan = this.array[this.index]
				this.$myRequest({
					url: "/getPrincipalEntbyText?entPlan=" + entPlan + "&text=" + this.text + "&pageIndex=" + this
