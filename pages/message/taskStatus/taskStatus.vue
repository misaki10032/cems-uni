...
export default {
  ...
  methods: {
    getTasks(callback) {
      this.$myRequest({
        url: "/getUserEnts?pageIndex=" + this.pageIndex + "&pageSize=" + this.pageSize + "&id=" + uni.getStorageSync("loginUser").userId,
        method: "GET",
        success: (res) => {
          console.log(res)
    ...
    bindPickerChange(res) {
      ...
      this.$myRequest({
        url: "/getUserEntsByPlan?entPlan=" + entPlan + "&pageIndex=" + this.pageIndex + "&pageSize=" + this.pageSize + "&id=" + uni.getStorageSync("loginUser").userId,
        method: "GET",
        success: res => {
          console.log(res)
    ...
    searchTasks() {
      ...
      const entPlan = this.array[this.index]
      this.$myRequest({
        url: "/getUserEntsByText?entPlan=" + entPlan + "&text=" + this.text + "&pageIndex=" + this.pageIndex + "&pageSize=" + this.pageSize + "&id=" + uni.getStorageSync("loginUser").userId,
        method: "GET",
        success: res => {
          this.hotTasks = res.data.data
          this.total = res.data.total
